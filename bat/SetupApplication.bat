...
:: Android packaging
set AND_CERT_NAME="yrdcAneTestBed"
set AND_CERT_PASS=yrdcTEST
set AND_CERT_FILE=cert\yrdcAneTestBed.p12
...
set IOS_PROVISION=cert\yrdcAneTestBed.mobileprovision
...
set APP_ID=air.com.yadurajiv.yrdcAneTestBed

:: Output packages
set DIST_PATH=dist
set DIST_NAME=yrdcAneTestBed
